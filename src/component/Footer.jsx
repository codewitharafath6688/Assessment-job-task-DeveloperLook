...
const Footer = () => {
  return (
    <footer className="bg-black text-white rounded-[30px] mx-2 sm:mx-3 mb-3 px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-12 overflow-hidden">

      {/* TOP SECTION */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 border-b border-gray-800 pb-10">

        {/* LEFT SIDE */}
        <div className="w-full sm:col-span-2 md:col-span-1">
          <h2 className="text-[24px] font-semibold leading-snug mb-6">
            Stay updated with Rise news
          </h2>

          {/* EMAIL INPUT */}
          <div className="flex items-center bg-zinc-900 rounded-full overflow-hidden w-full max-w-md mb-6">
            <input
              type="text"
              placeholder="Your Email Address"
              className="bg-transparent outline-none flex-1 text-gray-300 px-5 py-4"
            />

            <button className="bg-green-300 hover:bg-green-400 text-black rounded-full p-4 mr-1 transition-all duration-300 hover:rotate-45">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <div
                key={i}
                className="bg-white text-black px-3 py-2 rounded-full hover:rounded-md cursor-pointer flex items-center gap-1 transition-all duration-300"
              >
        ...
        {/* LINKS 1 */}
        <div className="space-y-2 border-l border-gray-800 pl-4 sm:pl-6 text-xl sm:text-2xl">
          {footerLink1.map((link, index) => (
            <p key={index}>
              <FooterLink content={link} />
            </p>
          ))}
        </div>
      ...
      <div className="py-10">
        <svg
          class="w-full h-[200px] object-contain fill-current"
      ...
      {/* BOTTOM */}
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center text-xs sm:text-sm text-white gap-4">

        <ul className="flex flex-wrap gap-2 sm:gap-3">
          <li>© 2025 Rise at Seven Ltd. All rights reserved</li>

          <li>
            <span className="font-bold">•</span> Company Number 11955187
          </li>

          <li>
            <span className="font-bold">•</span> VAT Registered GB 322402945
          </li>
          ...
          <li>
            <span className="font-bold">•</span> Terms &amp; conditions
          </li>
        </ul>
